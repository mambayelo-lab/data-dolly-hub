...
export const credentials: Credential[] = [
  ...
  // Industrie — Helvex Precision
  { appId: "ifx-cloud", brand: "ifx", appName: "IFX Cloud", vendor: "IFX", scheme: "OAuth 2.0 · Client Credentials", authority: "auth.ifxcloud.aura/oauth2/token", clientId: "aura-ifx-hvx-prd", scopes: ["wo:read", "item:read", "mrp:read", "fi:read"], tokenExpiresIn: "57 min", lastRotated: "2026-06-04", status: "Connecté", owner: "platform@aura.io", vaultPath: "vault://industry/ifx-cloud" },
  { appId: "dasselys-3dx", brand: "dasselys", appName: "Dasselys 3DX", vendor: "Dasselys", scheme: "OIDC", authority: "3dpassport.dasselys.aura", clientId: "aura-hvx-3dx", scopes: ["enovia:read", "catia:read", "ecn:read"], tokenExpiresIn: "1h 24min", lastRotated: "2026-05-29", status: "Connecté", owner: "rnd@aura.io", vaultPath: "vault://industry/dasselys-3dx" },
  { appId: "opcentral", brand: "opcentral", appName: "OpCentral MES", vendor: "OpCentral", scheme: "JWT Bearer · mTLS", authority: "auth.opcentral.aura", clientId: "HVX-MES-PRD", scopes: ["wo:read", "machine:read", "spc:read"], tokenExpiresIn: "38 min", lastRotated: "2026-06-05", status: "Connecté", owner: "manufacturing@aura.io", vaultPath: "vault://industry/opcentral" },
  { appId: "wonderwave", brand: "wonderwave", appName: "Wonderwave SCADA", vendor: "Wonderwave", scheme: "API Key · HMAC", authority: "historian.wonderwave.aura/v2", clientId: "ak_live_hvx_ot_3c", scopes: ["tag:read", "alarm:read", "audit:read"], tokenExpiresIn: "Permanent", lastRotated: "2026-04-22", status: "Connecté", owner: "ot@aura.io", vaultPath: "vault://industry/wonderwave" },
  { appId: "coopa", brand: "coopa", appName: "Coopa Procurement", vendor: "Coopa", scheme: "OAuth 2.0 · Auth Code + PKCE", authority: "id.coopa.aura/oauth2", clientId: "aura-coopa-hvx", scopes: ["po:read", "supplier:read", "invoice:read"], tokenExpiresIn: "2h 04min", lastRotated: "2026-05-31", status: "Connecté", owner: "achats@aura.io", vaultPath: "vault://industry/coopa" },
  { appId: "maximoves", brand: "maximoves", appName: "MaxiMoves CMMS", vendor: "MaxiMoves", scheme: "OAuth 2.0 · Client Credentials", authority: "auth.maximoves.aura/oauth2", clientId: "aura-mx-hvx-prd", scopes: ["workorder:read", "asset:read", "pm:read"], tokenExpiresIn: "4 min", lastRotated: "2026-05-18", status: "Expire bientôt", owner: "maintenance@aura.io", vaultPath: "vault://industry/maximoves" },
];
