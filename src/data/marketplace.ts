...
export const sectors: Sector[] = [
  ...
  },
  {
    ...
    description: "Matériaux de construction, équipements BTP, outillage professionnel. Logistique optimisée pour chantiers de toutes tailles.",
  ...
  },
  {
    ...
    description: "Composants électroniques, équipements IT, solutions télécoms et énergie solaire pour entreprises.",
...
export const suppliers: Supplier[] = [
  {
    ...
    rating: 4.8,
    reviewCount: 312,
    description: "Leader en équipements médicaux et diagnostics depuis 1998. Partenaire agréé de l'OMS, présent dans 80+ pays.",
    logo: "ME",
    logoColor: "#2D6A8F",
    established: 1998,
    minOrder: "5 000 €",
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 445,
    description: "Exportateur de produits agricoles et alimentaires de première qualité. Spécialité : grains, oléagineux, sucre et café pour marchés internationaux.",
    logo: "AK",
    logoColor: "#1B5E3E",
    established: 1995,
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 223,
    description: "Acier, ciment et matériaux de construction pour chantiers internationaux. Livraison CIF vers 32 ports dans le monde.",
    logo: "SB",
    logoColor: "#8B5E3C",
    established: 2003,
    minOrder: "10 000 USD",
  ...
  },
  {
    ...
    rating: 4.4,
    reviewCount: 156,
    description: "Composants électroniques, panneaux solaires et équipements IT pour marchés internationaux. Solutions plug-and-play clé en main.",
    logo: "TC",
    logoColor: "#1E4D8C",
    established: 2010,
    minOrder: "2 500 USD",
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 98,
    description: "Médicaments génériques, vaccins et dispositifs médicaux. Partenaire de 47 systèmes de santé dans le monde. Cold chain certifiée.",
    logo: "PS",
    logoColor: "#1B4F72",
    established: 1987,
    minOrder: "10 000 €",
...
export const campaigns: Campaign[] = [
  {
    id: "camp-001",
    title: "Gants chirurgicaux latex — Campagne Hôpitaux Q3",
    supplierId: "sup-001",
    sectorId: "health-cosmetics",
    productIds: ["prod-001"],
    description: "Commande groupée internationale de gants chirurgicaux en latex stériles grade premium. Certification CE et FDA. Idéal pour hôpitaux, cliniques et laboratoires. Livraison CIF vers tous ports.",
    image: "🧤",
    imageColor: "#2D6A8F",
    ...
    deliveryZones: ["Europe", "Amérique", "Asie", "Moyen-Orient", "Monde entier"],
    tags: ["médical", "prioritaire", "certifié"],
  },
  {
    id: "camp-002",
    title: "Filtres à huile moteur Diesel — Pack Flottes Industrielles",
    supplierId: "sup-003",
    ...
    whatsappEnabled: true,
    deliveryZones: ["Europe", "Moyen-Orient", "Asie du Sud-Est"],
  ...
  },
  {
    ...
    whatsappEnabled: true,
    deliveryZones: ["Europe", "Moyen-Orient", "Asie", "Monde entier"],
  ...
  {
    id: "camp-005",
    title: "Panneaux Solaires 400W Monocristallin — Énergie Verte Pro",
    supplierId: "sup-006",
    sectorId: "electronics-tech",
    productIds: ["prod-030"],
    description: "Panneaux solaires 400W monocristallins haute efficacité (22.4%). Garantie 25 ans de production. Idéal pour installations off-grid, mini-réseaux et parcs solaires.",
    image: "☀️",
    imageColor: "#1E4D8C",
    ...
    whatsappEnabled: true,
    deliveryZones: ["Europe", "Asie", "Moyen-Orient", "Monde entier"],
  ...
  {
    id: "camp-007",
    title: "Ciment Portland CPA 42,5 — Campagne Chantiers Pro",
    supplierId: "sup-005",
    sectorId: "construction",
    productIds: ["prod-050"],
    description: "Ciment Portland CPA 42,5 résistance haute, conditionnement 50kg. Idéal pour tous types de construction. Livraison CIF vers les principaux ports mondiaux.",
    image: "🏗️",
    imageColor: "#8B5E3C",
    ...
    whatsappEnabled: true,
    deliveryZones: ["Europe", "Moyen-Orient", "Monde entier"],
